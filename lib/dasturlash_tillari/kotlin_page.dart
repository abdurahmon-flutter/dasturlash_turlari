...
class KotlinPage extends StatefulWidget {
  static final String id = "kotlin_page";

  const KotlinPage({super.key});

  @override
  State<KotlinPage> createState() => _KotlinPage();
}

class _KotlinPage extends State<KotlinPage> {
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              background: Image(
                image: AssetImage("assets/images/kotlin.jpg"),
                fit: BoxFit.cover,
              ),
            ),
          ),
